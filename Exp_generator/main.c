...
#define FILENAME    wdev0_departure_time_trace_service_time.dat
#define START         0.0              /* initial time                   */
#define STOP      20000.0              /* terminal (close the door) time */
#define INFINITYY   (100.0 * STOP)      /* must be much larger than STOP  */
...
int main(void)
{
    FILE *fp; 				/* input data file: arrival     */
    FILE *fp_ser; 			/* input data file: service     */
    FILE* fp_dpt;			/* output data file: depature time*/
